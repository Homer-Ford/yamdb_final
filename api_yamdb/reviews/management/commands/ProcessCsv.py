...
class Command(BaseCommand):
    ...
    def handle_titles(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, 'static', 'data',
    ...
    def handle_review(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, 'static', 'data',
    ...
    def handle_comments(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, 'static', 'data',
    ...
    def handle_genre(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, 'static', 'data',
    ...
    def handle_genre_titles(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, 'static', 'data',
